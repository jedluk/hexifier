...
export function Selector(props: SelectorProps) {
  ...
  return (
    <select
      ...
      className="w-7/12 md:w-full sm:mr-4 md:mr-0 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-50 p-2.5"
    >
      {options.map((hexSize) => (
