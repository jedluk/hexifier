...
export function Upload() {
  return (
    <div className="grow group border border-dashed border-gray-300 hover:border-gray-500 ease-in duration-300 rounded-sm flex flex-col justify-center items-center cursor-pointer">
